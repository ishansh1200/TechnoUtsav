        ...
        >
            ...
            <motion.div className="flex-1 lg:ml-8 lg:mr-4 mb-8 lg:mb-0 overflow-y-auto" variants={fadeIn}>
                ...
                >
                    ...
                    <div className="text-lg lg:text-xl text-cyan-100 space-y-5">
                        <p className="leading-relaxed">
                            Robo Soccer is a captivating competition that blends the thrill of sports with the ingenuity of robotics. Teams of students are challenged to design, build, and program autonomous robots to compete in exciting soccer matches on a miniature field.
                        </p>
                        <ul className="space-y-4">
                            {[
                                "Develop sophisticated navigation algorithms",
                                "Implement strategic decision-making systems",
                                "Combine mechanics, electronics, and AI",
                                "Foster teamwork and collaborative problem-solving",
                                "Apply theoretical knowledge to real-world challenges",
                                "Compete in dynamic robotic soccer matches"
                            ].map((item, i) => (
                                <motion.li
                                    key={i}
                ...
                >
                    ...
                    <ul className="space-y-4 text-cyan-100">
                        {[
                            "Hands-on robotics and AI experience",
                            "Develop teamwork and collaboration skills",
                            "Enhance strategic problem-solving abilities",
                            "Showcase technical creativity and expertise",
                            "Network with industry professionals",
                            "Compete in innovative engineering challenges"
                        ].map((item, i) => (
                            <motion.li
                                key={i}
                                className="flex items-start gap-3"
                    ...
                    <ul className="space-y-4 text-cyan-100">
                        {[
                            ...
                            "Team-based participation (up to 4 members)",
                            "Enthusiasm for innovation and learning"
                        ].map((item, i) => (
                            <motion.li
                                key={i}
                                className="flex items-start gap-3"
            ...
            >
                ...
                <div className="space-y-8">
                    ...
                    >
                        {[
                            { href: 'https://unstop.com/p/mechasoccer-robo-soccer-vivekananda-institute-of-professional-studies-vips-delhi-1394411', text: 'Registration Form' },
                            { href: 'https://docs.google.com/document/d/1hcn9x137QIU3TVjkJ5GQ_sAGQciWU2TU/edit?usp=sharing&ouid=105713651815631722856&rtpof=true&sd=true', text: 'Event Details' }
                        ].map((link, i) => (
