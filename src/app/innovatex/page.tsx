            ...
            <motion.div className="flex-1 lg:ml-8 lg:mr-4 mb-8 lg:mb-0 overflow-y-auto" variants={fadeIn}>
                ...
                >
                    ...
                    <div className="text-lg lg:text-xl text-cyan-100 space-y-5">
                        <p className="leading-relaxed">
                            InnovateX: The College Ideathon 2025 is an electrifying platform designed to cultivate innovation, critical thinking, and entrepreneurial skills among college students.
                        </p>
                        <ul className="space-y-4">
                            {[
                                "Cross-disciplinary teams solving real-world problems",
                                "Mentorship from industry leaders and experts",
                                "Prototype development with cutting-edge technologies",
                                "Professional pitch sessions to investors",
                                "Focus on sustainable and scalable solutions",
                                "End-to-end innovation lifecycle experience"
                            ].map((item, i) => (
                                <motion.li
                                    key={i}
                ...
                >
                    ...
                    <ul className="space-y-4 text-cyan-100">
                        {[
                            "Develop end-to-end innovation capabilities",
                            "Hands-on experience with industry mentorship",
                            "Enhance cross-functional collaboration skills",
                            "Opportunity to launch viable ventures",
                            "Network with industry professionals",
                            "Showcase creativity to potential investors"
                        ].map((item, i) => (
                            <motion.li
                                key={i}
                                className="flex items-start gap-3"
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="border-b border-cyan-400/30 pb-6">
                            ...
                            <h3 className={`text-xl font-bold text-amber-400 ${orbitron.className}`}>VIPS-TC Seminar Hall</h3>
                        </div>
                        ...
                        <div className="pb-6">
                            ...
                            <h3 className={`text-xl font-bold text-amber-400 ${orbitron.className}`}>11:00 AM to 5:00 PM</h3>
                        </div>
                    </div>
                    ...
                    >
                        {[
                            { href: 'https://unstop.com/p/innovatex-vivekananda-institute-of-professional-studies-vips-delhi-1392460', text: 'Registration Form' },
                            { href: 'https://docs.google.com/document/d/1EU1Fa1_0sNkW2g5OIf1v0N3fPjEm2LPD/edit?usp=sharing&ouid=105713651815631722856&rtpof=true&sd=true', text: 'Event Details' }
                        ].map((link, i) => (
